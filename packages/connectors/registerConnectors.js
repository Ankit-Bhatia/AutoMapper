...
defaultRegistry.register('jackhenry-silverlake', {
    id: 'jackhenry-silverlake',
    displayName: 'Jack Henry SilverLake',
    category: 'banking',
    description: 'Jack Henry SilverLake core banking platform for commercial banks. ' +
...
defaultRegistry.register('jackhenry-coredirector', {
    id: 'jackhenry-coredirector',
    displayName: 'Jack Henry Core Director',
    category: 'banking',
    description: 'Jack Henry Core Director core banking platform for community banks. ' +
        'Connects via jXchange SOAP/XML with OAuth 2.0 authentication. ' +
...
defaultRegistry.register('jackhenry-symitar', {
    id: 'jackhenry-symitar',
    displayName: 'Jack Henry Symitar (Episys)',
    category: 'banking',
    description: 'Jack Henry Symitar / Episys core banking platform for credit unions. ' +
...
defaultRegistry.register('jackhenry-mcp', {
    id: 'jackhenry-mcp',
    displayName: 'Jack Henry jXchange (MCP)',
    category: 'banking',
    description: 'Jack Henry jXchange API via Model Context Protocol (MCP). ' +
...
defaultRegistry.register('salesforce', {
    id: 'salesforce',
    displayName: 'Salesforce CRM',
    category: 'crm',
    description: 'Salesforce Cloud CRM platform for sales, service, and marketing operations. ' +
...
defaultRegistry.register('sap', {
    id: 'sap',
    displayName: 'SAP S/4HANA',
    category: 'erp',
    description: 'SAP S/4HANA enterprise resource planning system. ' +
