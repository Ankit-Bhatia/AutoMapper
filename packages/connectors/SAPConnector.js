...
function buildMockSAPSchema(objectNames) {
    const templates = {
        BusinessPartner: [
        ...
        GLAccount: [
            ...
            { name: 'GLAccount', label: 'GL Account Number', dataType: 'string', isKey: true, required: true, complianceTags: ['SOX_FINANCIAL'] },
            { name: 'AccountName', label: 'Account Name', dataType: 'string', length: 50, complianceTags: ['SOX_FINANCIAL'] },
            { name: 'AccountType', label: 'Account Type', dataType: 'picklist', picklistValues: ['A', 'B', 'C', 'D', 'E'], complianceTags: ['SOX_FINANCIAL'] },
            { name: 'Currency', label: 'Currency', dataType: 'string', length: 5, complianceTags: ['SOX_FINANCIAL'] },
            { name: 'DebitCredit', label: 'Debit/Credit Indicator', dataType: 'string', length: 1, complianceTags: ['SOX_FINANCIAL'] },
        ],
        CostCenter: [
            { name: 'ControllingArea', label: 'Controlling Area', dataType: 'string', isKey: true, required: true },
            { name: 'CostCenter', label: 'Cost Center', dataType: 'string', isKey: true, required: true, complianceTags: ['SOX_FINANCIAL'] },
            { name: 'Name', label: 'Cost Center Name', dataType: 'string', length: 50, complianceTags: ['SOX_FINANCIAL'] },
...
function buildMockSAPData(objectName, limit) {
    const samples = {
        BusinessPartner: [
