...
const SYMXCHANGE_SERVICE_GROUPS = {
    Account: ['Share', 'Loan'],
...
function buildSymitarSchema(objectName, _entityId) {
    const id = () => uuidv4();
    const schemas = {
        Member: {
            label: 'Member',
...
function buildSymitarSamples(objectName, limit) {
    const samples = {
        Member: [
