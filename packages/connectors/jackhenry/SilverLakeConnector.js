...
export class SilverLakeConnector {
    mode = 'mock';
    credentials = {};
    accessToken = null;
...
function buildSilverLakeSchema(objectName, _entityId) {
    const id = () => uuidv4();
    const schemas = {
        CIF: {
            label: 'Customer Information File',
            description: 'Master record for each customer relationship in the bank. ISO 20022: Party. ' +
        ...
        GLAccount: {
            ...
            description: 'Chart of accounts entries for the bank. ISO 20022: Account. ' +
...
function buildSilverLakeSamples(objectName, limit) {
    const samples = {
        CIF: [
